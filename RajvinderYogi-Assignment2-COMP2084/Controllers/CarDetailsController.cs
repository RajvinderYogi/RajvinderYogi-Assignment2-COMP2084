...
namespace RajvinderYogi_Assignment1_COMP2084.Controllers
{
    public class CarDetailsController : Controller
    {
        ...
        {
            var carDetails = db.CarDetails.Include(c => c.ClassicCar);
        ...
        {
            ViewBag.CarId = new SelectList(db.ClassicCars, "CarId", "CarName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "DetailsId,CarId,CarBrand,CarModel,CarYear")] CarDetail carDetail)
        {
